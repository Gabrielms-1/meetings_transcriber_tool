...
def summarize_dialogue(model, tokenizer, dialogue: dict) -> str:
    ...
    """
    prompt = (
        "It follows a conversation separated by the turns of each participant, being these separated by A, B, C, etc.:\n\n"
        + json.dumps(dialogue, ensure_ascii=False, indent=2)
        + "\n\nPlease generate a long text in markdown that summarizes and organizes this conversation. I want to read a long text that explains what happened in the meeting, then a paragraph with the next steps."
    )
