...
def summarize_dialogue(model, tokenizer, dialogue: dict) -> str:
    ...
    prompt = (
        ...
        The conversation is separated by the turns of each participant, being these separated by letters (A, B, C, etc.). \
        The conversation is in the following JSON format. \
        You should read the conversation considering speakers by IDs (A, B, C, etc.). \
        After reading the conversation, generate a long text in markdown that synthesizes and organizes this conversation. \
        I want to read a long text that explains what happened in the meeting and what decisions were made, then a paragraph with the next steps. \
        The expected output format is a long text explaining about the meeting and after this, keypoints about the next steps"
